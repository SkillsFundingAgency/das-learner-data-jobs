...
{
    public class HandleApprenticeshipStopDateChangedEvent(ILearnerDataJobsOuterApi outerApi, ILogger<HandleApprenticeshipStoppedEvent> log) : IHandleMessages<ApprenticeshipStopDateChangedEvent>
    {
